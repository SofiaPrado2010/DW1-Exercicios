...
function inserir() {
    ...
    mostrarAviso("INSERINDO - Digite o nome da pagamento e clique em salvar");
}
...
function mostrarDadosPagamento(p) {
    document.getElementById("inputId_forma_pagamento").value = p.id_forma_pagamento;
    document.getElementById("inputNome_forma_pagamento").value = p.nome_forma_pagamento;
    bloquearAtributos(true);
}
